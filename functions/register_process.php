...
if (!empty($_POST)) 
{
    ...
    else 
    {
        ...
        $query = "INSERT INTO `register_table`(`register_full_name`, `register_user_name`, `register_password`, `register_contact_number`, `register_email`, `register_question`, `register_answer`, `register_time`) 
                  VALUES ('$fullname', '$username', '$hashed_password', '$contact_number', '$email', '$question', '$answer', '$time')";
